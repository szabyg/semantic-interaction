 ...
 */
SIF.Contexts.document = new SIF.Context('sif.context.Document');

SIF.Contexts.document.options = {};

SIF.Contexts.document.rdf = jQuery.rdf();

SIF.Contexts.document.init = function () {
